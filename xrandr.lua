...
--
-- pulled from:
--     https://github.com/vincentbernat/awesome-configuration/rc/xrandr.lua
--
-- TODO:
...
local icons = import("icons", "icons")
...
function xrandr()
    ...
    if not next then
        label, icon = "Keep the current configuration", icons.lookup({
            name = "display",
            type = "devices"
        })
